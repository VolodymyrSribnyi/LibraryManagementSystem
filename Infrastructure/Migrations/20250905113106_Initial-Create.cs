        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValidTo = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2026, 9, 5, 11, 31, 5, 584, DateTimeKind.Utc).AddTicks(5485)),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LibraryCard_ApplicationUser_UserId",
                        column: x => x.UserId,
                        principalTable: "ApplicationUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2025, 9, 5, 11, 31, 5, 587, DateTimeKind.Utc).AddTicks(9304)),
                    EndsAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2025, 9, 19, 11, 31, 5, 587, DateTimeKind.Utc).AddTicks(9714)),
