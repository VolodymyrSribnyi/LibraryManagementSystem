...
namespace Application.ErrorHandling
{
    public static class Errors
    {
        ...
        public static readonly Error LibraryCardNotFound = new Error("LIBRARY_CARD_NOT_FOUND", "The specified library card was not found. You need to register for one");
